...
//YwToastWidget
class YwToastWidget extends StatelessWidget {
  const YwToastWidget({
    Key key,
    @required this.msg,
    this.image,
...
_HideCallback _showYwToast({
  ...
  var backButtonName = 'YwToast$backButtonIndex';
